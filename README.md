...
```mermaid
flowchart LR
    A([💻 Commit]) --> B[🧪 Build e testes<br/>GitHub Actions]
    B --> C[🐳 Imagem<br/>Docker]
    C --> D[🏗️ Infraestrutura<br/>Terraform + Ansible]
    D --> E[🚀 Deploy<br/>EC2 · ECS]
    E --> F[📈 Observabilidade<br/>OpenTelemetry · Grafana]
    F -. feedback: SLO e Error Budget .-> A

    classDef etapa stroke:#7AA2F7,stroke-width:2px
...
![Amazon ECS](https://img.shields.io/badge/ECS-FF9900?style=for-the-badge&logo=amazonecs&logoColor=white)
...
![SRE](https://img.shields.io/badge/SRE-4B32C3?style=for-the-badge)
![SLO & Error Budget](https://img.shields.io/badge/SLO_%26_Error_Budget-4B32C3?style=for-the-badge)
...
![Redes](https://img.shields.io/badge/Redes-VLANs_%26_Intranet-0A7EA4?style=for-the-badge)
...
[![integracao-continua-go](https://img.shields.io/github/actions/workflow/status/STUG9000/integracao-continua-go/go.yml?label=integracao-continua-go&style=for-the-badge&logo=githubactions&logoColor=white)](https://github.com/STUG9000/integracao-continua-go/actions)
[![FINAN-ASPRO](https://img.shields.io/github/actions/workflow/status/STUG9000/FINAN-ASPRO/deploy.yml?label=FINAN-ASPRO%20deploy&style=for-the-badge&logo=githubactions&logoColor=white)](https://github.com/STUG9000/FINAN-ASPRO/actions)
